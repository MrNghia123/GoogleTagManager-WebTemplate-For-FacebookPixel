...
{
  "displayName": "WoolyTech Meta Pixel",
  "__wm": "VGVtcGxhdGUtQXV0aG9yX0ZhY2Vib29rLVNpbW8tQWhhdmE\u003d",
  "description": "Updated Google Tag template for Meta pixel, forked from Simo Ahava Facebook Pixel template",
  "securityGroups": [],
  "categories": [
    "ADVERTISING",
    "ANALYTICS"
  ...
  "version": 1,
  "brand": {
    "displayName": "gtm-templates-woolytech",
    "id": "github.com_gtm-templates-woolytech",
